...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../labfinal_soc.sopcinfo
...
# Design Name 
# setting SOPC_NAME is labfinal_soc
SOPC_NAME := labfinal_soc
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x8005178
SOPC_SYSID_FLAG += --sidp=0x8005178
ELF_PATCH_FLAG  += --sidp 0x8005178

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1638916184
SOPC_SYSID_FLAG += --timestamp=1638916184
ELF_PATCH_FLAG  += --timestamp 1638916184
